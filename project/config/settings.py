...
SECRET_KEY = 'django-insecure-y23tws*hr9g55e6_eh986o*4(6nm*!dt8#ij=b(3yr^gqy68ix'
...
DATABASES = {
    "default": django_mongodb_backend.parse_uri("mongodb://localhost:27017/route-logger"),
}
